...
- Documentation only, no code change: a CI badge under the title, the publishing section records the OIDC trusted-publishing path, and the Chinese README gains the install section its English sibling already had.
